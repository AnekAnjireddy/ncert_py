...
\begin{align}
p_Y\brak{9} &= \frac{1}{\sqrt{2\pi \brak{\frac{5}{4}}}} e^{-\frac{\brak{x-\frac{5}{2}}^2}{2 \brak{\frac{5}{4}}}} \\
...
\begin{align}
p_Y\brak{2.5<Y<3.5}&=F_Y(3.5)-F_Y(2.5)\\
&=Q\brak{\frac{3.5-\mu}{\sigma}}-Q\brak{\frac{2.5-\mu}{\sigma}}\\
&=Q\brak{0.8944}-Q\brak{0}\\
&= 0.314446
\end{align}
\end{enumerate}
